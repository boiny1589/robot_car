...
import actionlib
import sys
sys.path.insert(0, "/home/meroke/ros_catkin_ws/install/lib/python3/dist-packages")
...
class Navigation:
    ...
    def coordinates_init(self):
        ...
        #每个分组第一个坐标为左侧箱子
        self.coordinates.append([3.5, -0.10])  # p0 #左上角
        self.coordinates.append([3.0, -0.10])  # p1 
        self.coordinates.append([3.49, 1.30])  # p2 #左下角
        self.coordinates.append([2.91, 1.30])  # p3 
        self.coordinates.append([1.88, -0.10])  # p4 #中间
        self.coordinates.append([1.32, -0.10])  # p5 
        
        self.coordinates.append([-0.32, 1.25])  # p6 # 右下角
        self.coordinates.append([0.32, 1.25])  # p7
        

        self.coordinates.append([-0.32, -0.10])  # p8 #右上角
        self.coordinates.append([0.32, -0.10])  # p9
        ...
        # 抓取点 1.5 ~ 3.5
        self.coordinates.append([0.77, 1.43])  # g0 *
        ...
        self.coordinates.append([2.47, 1.43])  # g6 *

        # self.coordinates.append([3.10, 1.95])    # start
        self.coordinates.append([0.0, 0.0])    # start
        self.coordinates.append([1.6, 0.59])    # middle
